...
@AndroidEntryPoint
public class AddSameFolderNameDialog extends DialogFragment {
    @Inject
    ...
    private AlertDialog getAlertDialog() {
        return dialogBuilder.makeConfirmDialog(getString(R.string.dialog_message_same_folder_name_add))
    ...
    private View.OnClickListener getPositiveClickListener() {
        return v -> {
            model.insert();
            navController.popBackStack(R.id.addFolderDialog, true);
        };
    }
}
