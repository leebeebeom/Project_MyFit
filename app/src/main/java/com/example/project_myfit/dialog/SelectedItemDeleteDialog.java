...
public class SelectedItemDeleteDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(requireContext(), R.style.myAlertDialog)
                ...
                .setMessage(amount + getString(R.string.selected_item_delete_check))
                .setNegativeButton(R.string.cancel, null)
                .setPositiveButton(R.string.confirm, (dialog1, which) -> mListener.selectedItemDeleteConfirmClick())
                .show();
